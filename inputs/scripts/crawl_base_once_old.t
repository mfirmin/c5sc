...
ACTIONS
	...
	POSE rAnkle(-1.4,1000.,100.), lAnkle(-1.4,1000.,100.);
...
ACTIONS
	...
	POSE rHip(-2.2, 1000., 100.), lHip(-1.57, 1000., 100. );
	POSE rKnee(1.8,1000.,100.), lKnee(1.6,1000.,100.);
	POSE rAnkle(-1.5,1000.,100.), lAnkle(-1.4,1000.,100.);
...
ACTIONS
	...
	POSE lKnee(1.8,1000.,100.), rKnee(1.6,1000.,100.);
	POSE lAnkle(-1.5,1000.,100.), rAnkle(-1.4,1000.,100.);
